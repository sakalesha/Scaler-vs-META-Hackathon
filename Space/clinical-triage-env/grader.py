...
from models import Action, EnvironmentState, GraderResponse
...
class Grader:
    """
    Standard OpenEnv Grader class.
    """
    def __init__(self):
        pass

    def grade(self, request_data: dict) -> GraderResponse:
        ...
        # ── discharge / admit ─────────────────────────────────────────────────────
            ...
            if patient.assigned_esi is None:
                ...
                score     = 0.40
                rationale = "Suboptimal disposition match."
...
def grade(request_data: dict) -> GraderResponse:
    """External API wrapper for the Grader class."""
    return Grader().grade(request_data)
